    ...
    return (
        <div className={`bg-[#818582]/10 h-full p-5 rounded-r-xl overflow-y-scroll text-white ${selectedUser ? "max-md:hidden" : ''}`}>
            <div className='pb-5'>
                ...
                <div className='bg-[#282142] rounded-full flex item-center item-center gap-2 py-3 px-4 mt-4'>
                    <img src={assets.search_icon} alt="Search" className='w-3' />
                    <input type='text' className='bg-transparent border-none outline-none text-white text-xs placeholder-[#cBcBcB] flex-1' placeholder='Search User...' />
                </div>
            </div>
            ...
            <div className='flex flex-col'>
                {userDummyData.map((user,index)=>(
                    ...
                    cursor-pointer max-sm:text-sm ${selectedUser?._id === user._id && 'bg-[#28282142]/50'}`}>
